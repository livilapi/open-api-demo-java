...
//            if($row['po_expired'] == 1)
    ...
    <div class="win_btn"><button type="button" onclick="javascript:location.href='../plugin/paybank/point_topup.php'">포인트충전</button> <button type="button" onclick="javascript:window.close();">창닫기</button></div>
</div>