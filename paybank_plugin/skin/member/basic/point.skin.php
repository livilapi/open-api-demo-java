...
<div id="point" class="new_win">
    ...
    <div class="new_win_con list_01">
        ...
        <ul>
            ...
            <li>
                <span>
                    <a href="javascript:location.href='../plugin/paybank/point_popup.php'" style="line-height: 25px;padding: 0 5px;border-radius: 3px;display: inline-block;background: #d13f4a;color: #fff;text-decoration: none;text-align: right;vertical-align: middle;">포인트 충전</a>
                </span>
            </li>
        </ul>
